...
✏️ Основная цель проекта была в освоении инструмента, но замечу, что результаты использования этой модели в таком режиме получались не особо удачными, особенно при попытках корректировки. imho, для цели генерирования логитипов (с возможностью корректировки по результату) понадобится поэкспериментировать с промптами или параметрами для этой модели или поискать другую. 
