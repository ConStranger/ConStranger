...
- инструменты и платформы для создания решений с использованием ИИ: API, Python, векторные базы данных, RAG, OpenAI Platform, Yandex Cloud, OpenRouter, а также методы дообучения моделей;
...
### Агент для обработки обращений клиентов
...
Задача агента понять суть запроса пользователя, классифицировать его, найти нужные данные, сформировать ответ для клиента и саммари для оператора/менеджера. Агент ведет лог обращений в виде тикетов с отметками требуется ли последующее участие менеджера или обращение обработано автоматически. Работа с источниками данных упрощена, используются предопределенные json файлы для каталога товаров и реесстра заказов. Возможна работа через telegram.

[Пример результата]() ([project repository 🔒](https://github.com/ConStranger/learn-zc-oc26))
